"""
Django settings for PlantesManager project.
...
ROOT_URLCONF = 'PlantesManager.urls'
...
WSGI_APPLICATION = 'PlantesManager.wsgi.application'

ASGI_APPLICATION = 'PlantesManager.asgi.application'
